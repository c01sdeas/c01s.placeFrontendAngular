...
@Component({
    ...
    template: `<div class="card">
        ...
        <ul class="p-0 mx-0 mt-0 mb-6 list-none">
            <li class="flex items-center py-2 border-b border-surface">
                <div class="flex flex-col">
                    <div class="w-full h-12 flex items-center justify-center bg-blue-100 dark:bg-blue-400/10 rounded-full mr-4 shrink-0">
            ...
            <li class="flex items-center py-2">
                <div class="w-full h-12 flex items-center justify-center bg-orange-100 dark:bg-orange-400/10 rounded-full mr-4 shrink-0">
        ...
        <ul class="p-0 m-0 list-none mb-6">
            ...
            <li class="flex items-center py-2 border-b border-surface">
                <div class="w-full h-12 flex items-center justify-center bg-pink-100 dark:bg-pink-400/10 rounded-full mr-4 shrink-0">
        ...
        <ul class="p-0 m-0 list-none">
            <li class="flex items-center py-2 border-b border-surface">
                <div class="w-full h-12 flex items-center justify-center bg-green-100 dark:bg-green-400/10 rounded-full mr-4 shrink-0">
            ...
            <li class="flex items-center py-2 border-b border-surface">
                <div class="w-full h-12 flex items-center justify-center bg-purple-100 dark:bg-purple-400/10 rounded-full mr-4 shrink-0">
